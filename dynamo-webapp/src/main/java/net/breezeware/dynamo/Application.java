...
@PropertySources({ @PropertySource(value = { "classpath:internal.properties" }),
		@PropertySource(value = "file:/usr/local/dynamo/dynamo-webapp/conf/application.properties", ignoreResourceNotFound = true) })
public class Application extends SpringBootServletInitializer {
	...
	// FIXME: remove the comment and diagnose the problem of library not present
