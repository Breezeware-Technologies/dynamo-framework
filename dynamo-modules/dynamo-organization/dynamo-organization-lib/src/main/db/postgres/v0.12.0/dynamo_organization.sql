...
INSERT INTO dynamo.dynamo_org_user (id, organization_id, password, status, email, first_name, last_name, middle_initial, created_date, modified_date) VALUES (1,2,'$2a$10$1sw/Lc92UciLrXwC4uPx/OT8MiG0AUANtCTuBs5YP8xBwRDDib9ta', 'ACTIVE', 'karthik@breezeware.net', 'Karthik','Muthukumaraswamy',NULL, now(), now()),(2,2,'sivaram','ACTIVE','sivaram@breezeware.net','Sivaram','Muthuswami',NULL,now(),now()),(3,2,'rsiva','ACTIVE','rsiva@breezeware.net', 'Siva','R',NULL,now(),now()),(4,2,'gowtham','ACTIVE','gowtham@breezeware.net', 'Gowtham','Jayaraman',NULL,now(),now()),(5,2,'siddharth','ACTIVE','siddharth@breezeware.net', 'Siddharth','Elanchezian',NULL,now(),now());
